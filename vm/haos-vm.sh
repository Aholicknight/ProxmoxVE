...
if [[ -n "$SOURCE_URL" ]]; then
  APP_TITLE="<a href='${SOURCE_URL}' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: inherit;'>Homeassistant OS VM</a>"
else
  APP_TITLE="Homeassistant OS VM"
fi
DESCRIPTION=$(
  cat <<EOF
<div align='center'>

...
if [[ -n "$SOURCE_URL" ]]; then
  APP_TITLE="<a href='${SOURCE_URL}' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: inherit;'>Mikrotik RouterOS CHR</a>"
else
  APP_TITLE="Mikrotik RouterOS CHR"
fi
DESCRIPTION=$(
  cat <<EOF
<div align='center'>

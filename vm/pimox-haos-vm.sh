...
# Source: https://github.com/jiangcuo/Proxmox-Port
...
if [[ -n "$SOURCE_URL" ]]; then
  APP_TITLE="<a href='${SOURCE_URL}' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: inherit;'>Homeassistant VM</a>"
else
  APP_TITLE="Homeassistant VM"
fi
DESCRIPTION=$(
  cat <<EOF
<div align='center'>

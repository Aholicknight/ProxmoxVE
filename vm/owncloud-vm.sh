...
# Source: https://www.turnkeylinux.org/owncloud
...
if [[ -n "$SOURCE_URL" ]]; then
  APP_TITLE="<a href='${SOURCE_URL}' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: inherit;'>Owncloud VM</a>"
else
  APP_TITLE="Owncloud VM"
fi
DESCRIPTION=$(
  cat <<EOF
<div align='center'>
